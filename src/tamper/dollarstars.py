...
"""
About: Adds dollar sign followed by an asterisk ($*) between the characters in a given payload.
Notes: This tamper script works against target(s) with a POSIX shell.
"""

__tamper__ = "dollarstars"
...
"""
The other spelling of the same emptiness.

A shell with no positional parameters expands '$*' to nothing, exactly as it does '$@' - so this
says what 'dollaratsigns' says in the character a filter written against that one may not carry.
"""
obf_char = "$*"
