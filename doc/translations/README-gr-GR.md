...
* **Παράκαμψη φίλτρων και WAF** - Πολλαπλά συνδυάσιμα scripts παραποίησης (tamper) για το κέλυφος και για τον κώδικα που αξιολογείται, με ντετερμινιστική σειρά εφαρμογής.
